...
/**
 * Parse a strict county-to-CID fallback map.
 *
 * These maps stay separate from stable IPNS maps. Donphan keeps the IPNS URL
 * as the reviewed publication identity while DuckDB reads the immutable CID
 * directly, avoiding stale gateway HEAD/range caches.
 *
...
/**
 * Build the direct immutable Filebase URL used by DuckDB.
 *
